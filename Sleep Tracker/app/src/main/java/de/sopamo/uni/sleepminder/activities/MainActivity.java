...
//implements SensorEventListener for temperature functionality
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.ICE_CREAM_SANDWICH){
            mtemp= mSensorManager.getDefaultSensor(Sensor.TYPE_AMBIENT_TEMPERATURE); // requires API level 14.
        }
        //END SENSOR STUFF*/
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        temperaturelabel.setText(String.valueOf(ambient_temperature) + " \u2103");
    }
